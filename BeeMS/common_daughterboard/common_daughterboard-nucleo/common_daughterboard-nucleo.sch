...
F 2 "Resistor_SMD:R_1206_3216Metric" V 1490 2590 50  0001 C CNN
...
F 2 "Resistor_SMD:R_1206_3216Metric" V 1490 3890 50  0001 C CNN
...
F 1 "4700pF" H 550 3400 50  0000 L CNN
...
F 1 "+12V" H 2150 1150 50  0000 C CNN
...
Wire Wire Line
	2700 1100 2750 1100
Text GLabel 1900 1650 3    50   BiDi ~ 0
CAN_-
Wire Wire Line
	1900 1650 1900 1500
...
Wire Wire Line
	1900 1500 2750 1500
Text GLabel 2100 1650 3    50   BiDi ~ 0
CAN_+
Wire Wire Line
	2100 1650 2100 1600
...
U 1 1 5E458772
P 3150 1800
F 0 "#PWR010" H 3150 1550 50  0001 C CNN
...
F 1 "Inolux_IN-PI554FCH" H 4406 3055 50  0000 R CNN
F 2 "LED_SMD:LED_Inolux_IN-PI554FCH_PLCC4_5.0x5.0mm_P3.2mm" H 4800 2800 50  0001 L TNN
F 3 "http://www.inolux-corp.com/datasheet/SMDLED/Addressable%20LED/IN-PI554FCH.pdf" H 4850 2725 50  0001 L TNN
	1    4750 3100
	-1   0    0    -1  
$EndComp
$Comp
...
F 1 ".1uF" H 3265 2605 50  0000 L CNN
...
F 1 "PWR_FLAG" H 2550 1400 50  0000 C CNN
...
F 1 "OUT_CONN" H 1157 1876 50  0000 C CNN
F 2 "Connector_RJ:RJ45_Amphenol_RJHSE5380" V 1100 1325 50  0001 C CNN
...
U 1 1 5E98E99D
P 3150 1300
F 0 "J3" H 2820 1339 50  0000 R CNN
F 1 "IN_CONN" H 2820 1248 50  0000 R CNN
F 2 "Connector_RJ:RJ45_Amphenol_RJHSE5380" V 3150 1325 50  0001 C CNN
F 3 "~" V 3150 1325 50  0001 C CNN
	1    3150 1300
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "TL" H 3650 1250 50  0000 L CNN
...
F 1 "BL" H 3950 1250 50  0000 L CNN
...
F 1 "BR" H 4250 1250 50  0000 L CNN
...
F 1 "TR" H 4550 1250 50  0000 L CNN
